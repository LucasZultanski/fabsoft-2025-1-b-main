...
function getDashboardFilterParams() {
    const params = [];
    if (dashboardFilterStartDateISO) params.push(`startDate=${encodeURIComponent(dashboardFilterStartDateISO)}`);
    if (dashboardFilterEndDateISO) params.push(`endDate=${encodeURIComponent(dashboardFilterEndDateISO)}`);
...
async function fetchAdminData(type, period) {
    ...
    endpoint += getDashboardFilterParams();
...
async function renderCheckinsByGenderChart() {
...
async function renderCheckinsByStateChart() {
...
async function renderCheckinsByAgeGroupChart() {
...
async function renderCheckinsByCityChart() {
...
function applyDashboardFilters() {
    ...
    // Recarrega todos os dados do dashboard com os filtros
